package com.zagwork.test.interest.microservice.service.handler;

import com.zagwork.test.interest.microservice.core.exception.ResourceNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> resourceNotFound(ResourceNotFoundException exception, HttpServletRequest request) {
        RestError restError = new RestError(HttpStatus.NOT_FOUND, exception.getMessage(), request.getServletPath());
        return new ResponseEntity<>(restError, new HttpHeaders(), restError.getHttpStatus());
    }
